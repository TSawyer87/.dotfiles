    ...
    opts = {
        ...
        ui = {
            ...
            hl_groups = {
                ...
                ObsidianTodo = { bold = true, fg = "#f50c5e" },
                ObsidianDone = { bold = true, fg = "#89eeae" },
                ObsidianRightArrow = { bold = true, fg = "#ff9374" },
                ObsidianTilde = { bold = true, fg = "#a95b79" },
                ObsidianImportant = { bold = true, fg = "#85aaea" },
                ObsidianBullet = { bold = true, fg = "#a4aeaa" },
                ObsidianRefText = { underline = true, fg = "#c792aa" },
                ObsidianExtLinkIcon = { fg = "#c7511c" },
                ObsidianTag = { italic = true, fg = "#89deee" },
