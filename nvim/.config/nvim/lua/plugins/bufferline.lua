...
M.keys = {
    ...
    { "<A-,>", "<cmd>BufferLineMovePrev<cr>", noremap = true, silent = true, desc = "Move tab left" },
    { "<A-.>", "<cmd>BufferLineMoveNext<cr>", noremap = true, silent = true, desc = "Move tab right" },
...
M.config = function()
    require("bufferline").setup {
        ...
        -- highlights = require("tokyonight.plugins.bufferline").akinsho(),
