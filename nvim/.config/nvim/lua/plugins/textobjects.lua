                ...
                callback = function()
                    ...
                    map(
                        ...
                        "<cmd>lua require('various-textobjs').doubleSquareBrackets(false)<CR>",
                        {
                            ...
                            noremap = true,
                            silent = true,
                            desc = 'around double square brackets',
                        }
                    )
                end,
            })
